...
@section('content')
    <div class="d-flex align-items-center justify-content-between">
        <h1 class="h3 mb-3"><strong>Master</strong> Permissions</h1>
        @can('Permission Create')
            <a href="{{ route('master.permissions.create') }}" class="btn btn-primary">Create <i class="fas fa-plus"></i></a>
        @endcan
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".btnRemove").on('click', function() {
                let id = $(this).data('id');
                let url = '{{ route('master.permissions.destroy', ':id') }}'
