...
@section('content')
    <div class="d-flex align-items-center justify-content-between">
        <h1 class="h3 mb-3"><strong>Master</strong> Users</h1>
        @can('User Create')
            <a href="{{ route('master.users.create') }}" class="btn btn-primary">Create <i class="fas fa-plus"></i></a>
        @endcan
                            ...
                            @foreach ($users as $item)
                                <tr>
                                    ...
                                    @canany(['User Edit', 'User Delete'])
                                        <td>
                                            @can('User Edit')
                                                <a href="{{ route('master.users.edit', $item->uuid) }}"
