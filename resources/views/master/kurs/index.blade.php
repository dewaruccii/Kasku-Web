...
@section('content')
    <div class="d-flex align-items-center justify-content-between">
        <h1 class="h3 mb-3"><strong>Master</strong> Kurs</h1>
        @can('Kurs Create')
            <a href="{{ route('master.kurs.create') }}" class="btn btn-primary">Create <i class="fas fa-plus"></i></a>
        @endcan
                            ...
                            @foreach ($kurs as $item)
                                <tr>
                                    ...
                                    @canany(['Kurs Edit', 'Kurs Delete'])
                                        <td>
                                            @can('Kurs Edit')
                                                <a href="{{ route('master.kurs.edit', $item->uuid) }}"
